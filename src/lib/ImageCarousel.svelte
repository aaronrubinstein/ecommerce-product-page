...
<div class="embla">
    ...
    <button on:click={scrollPrev} class="scroll-prev-btn" type="button" aria-label="Previous image">
        <img class="arrow left-arrow" src="images/icon-previous.svg" alt="Left arrow">
    </button>
    <button on:click={scrollNext} class="scroll-next-btn" type="button" aria-label="Next image">
